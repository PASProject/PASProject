	...
	<header>
		...
		<div class="background-color" style="height: auto;">
			...
			<nav class="navbar navbar-default navbar-fixed-top container "
				role="navigation" id="navbar" style="background-color:<c:out value='${sessionScope.joinProjectVo.proj_Color}'/>">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right" id="a">
						<li><a id="myProjectList" style="background-color:<c:out value='${sessionScope.joinProjectVo.proj_Color}'/>"
							href="<%=request.getContextPath()%>/main/myProject"><p>참여
									프로젝트 보기</p></a></li>
						<li><a id="otherProjectList" style="background-color:<c:out value='${sessionScope.joinProjectVo.proj_Color}'/>"
		...
		<nav class="navbar navbar-inverse navbar-fixed-top container"
			role="navigation" id="navbar2" style="background-color:<c:out value='${sessionScope.joinProjectVo.proj_Color}'/>">
