...
<h1>FreeBoard</h1>
	<div style="border: solid 1px black;">
		<form name="frm" method="post">
			<input type="hidden" name="frb_Article_Num" id="frb_Article_Num" value="${freeBoardVo.frb_Article_Num}">
			<fieldset>
			<legend>${freeBoardVo.frb_Title}   <span>(${freeBoardVo.frb_Article_Num}) (${freeBoardVo.frb_Wt_Date})</span></legend>
		...
		<div style="background: gray">
			...
			<textarea rows="5" cols="50" id="frb_Reply_Content"></textarea><input type="button" value="등록" id="replyBtn">
		</div>
	</div>
	<div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#replyBtn').on('click',function(){
					...
					var dataWrite = {'frb_Article_Num':frb_Article_Num,'frb_Reply_Content':frb_Reply_Content};
					$.ajax({
